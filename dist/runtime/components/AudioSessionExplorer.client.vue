...
const downloadingSessionId = ref(null);
onMounted(async () => {
  try {
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            {{ t("audio-recorder.sessionExplorer.sessionId") }}: {{ session.id.slice(
  0,
  8
) }}...
                                        </p>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex gap-2 justify-end pt-4 border-t border-gray-100 dark:border-gray-800">
                                <UButton @click="downloadAudio(session.id)" color="primary" variant="soft"
                                    ...
                                    {{ downloadingSessionId === session.id ? t("audio-recorder.sessionExplorer.downloading") : t("audio-recorder.sessionExplorer.downloadMp3") }}
                                </UButton>
                                ...
                                <UButton @click="deleteSession(session.id)" color="error" variant="soft"
                                    ...
                                    class="transition-all duration-200 hover:scale-105">
                                    {{ deletingSessionId === session.id ? t("audio-recorder.sessionExplorer.deleting") : t("audio-recorder.sessionExplorer.delete") }}
                                </UButton>
                            </div>
                        </div>
                    </UCard>
