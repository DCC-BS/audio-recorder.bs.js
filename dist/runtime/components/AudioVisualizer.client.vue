...
<style scoped>
.audio-visualization{align-items:center;display:flex;height:50px;justify-content:space-between;margin-top:10px}.audio-visualization .bar{background-color:#4caf50;width:2%}
</style>
